...
fake_sentences = [nn.init.normal_(torch.empty(identity_size['E'], dtype=torch.float, requires_grad=True, device='cuda'), mean=0.0, std=0.1).view(input_size) for _ in range(1)]
